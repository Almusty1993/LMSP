...
export class UserService {
  ...
  resultsearch(
    ...
    return this.http.get<Ibooks[]>('http://localhost:3000/resultsearch', {
      params: httpParams,
    });
  }
  ...
  getinnerjoin(copy_id: any) {
    return this.http.get<Innerjoin[]>(
      'http://localhost:3000/getinnerjoin/' + copy_id
    );
  }
  ...
  onGethistory(user_id: any) {
    return this.http.get<Ihistory[]>(
      'http://localhost:3000/onGethistory/' + user_id
    );
  }

  onGetborrow(user_id: any) {
    return this.http.get<Ihistory[]>(
      'http://localhost:3000/onGetborrow/' + user_id
    );
  }

  gethighcategory(user_id: any) {
    return this.http.get<Ihistory[]>(
      'http://localhost:3000/gethighcategory/' + user_id
    );
  }

  getrecommand(category: any) {
    return this.http.get<Ihistory[]>(
      'http://localhost:3000/getrecommand/' + category
    );
  }

  fetchcopy(book_id: any) {
    return this.http.get<Icopy[]>(
      'http://localhost:3000/fetchallcopy/' + book_id
    );
  }

  getwishlist(user_id: any) {
    return this.http.get<Ibooks[]>(
      'http://localhost:3000/getwishlist/' + user_id
    );
  }
  ...
  updatename(email: any) {
    ...
    return this.http.put(
      'http://localhost:3000/person/updatePassword/' + email,
      options
    );
  }
  ...
  updatecopynumber(book_id: any) {
    ...
    return this.http.put(
      'http://localhost:3000/updatecopynumber/' + book_id,
      options
    );
  }
  ...
  deletewholecopyBook(book_id: any) {
    return this.http.delete(
      'http://localhost:3000/deletewholecopioes/' + book_id
    );
  }
  ...
  updatecopyavailabe(copy_id: any, data: any) {
    ...
    return this.http.put(
      'http://localhost:3000/copyavailabe/' + copy_id,
      data,
      options
    );
  }
